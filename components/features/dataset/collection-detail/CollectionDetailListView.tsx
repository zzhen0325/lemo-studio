...
import { CollectionDetailListItem } from '@/components/features/dataset/collection-detail/CollectionDetailListItem';
import { getPromptByLang } from '@/components/features/dataset/collection-detail/collection-detail.utils';
import type {
  CropMode,
  DatasetImage,
  TranslateLang,
