...
import { CollectionDetailHeader } from "@/components/features/dataset/collection-detail/CollectionDetailHeader";
import { CollectionDetailPrefixBar } from "@/components/features/dataset/collection-detail/CollectionDetailPrefixBar";
import { CollectionDetailListView } from "@/components/features/dataset/collection-detail/CollectionDetailListView";
import { CollectionDetailGridView } from "@/components/features/dataset/collection-detail/CollectionDetailGridView";
import {
    getPromptByLang,
    normalizePromptFields,
    setPromptByLang,
} from "@/components/features/dataset/collection-detail/collection-detail.utils";
import { useCollectionDetailAiWorkflow } from "@/components/features/dataset/collection-detail/useCollectionDetailAiWorkflow";
import { processCollectionUpload } from "@/components/features/dataset/collection-detail/collection-detail.upload";
