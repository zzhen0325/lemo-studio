...
exports.SYSTEM_PROMPT_PROFILES = void 0;
exports.getSystemPrompt = getSystemPrompt;
exports.SYSTEM_PROMPT_PROFILES = {
    'optimization': {
        defaultPrompt: `# 角色
...
function getSystemPrompt(profileId, providerId) {
    const profile = exports.SYSTEM_PROMPT_PROFILES[profileId];
    if (!profile)
        return "";
