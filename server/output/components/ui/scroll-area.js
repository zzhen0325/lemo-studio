...
const ScrollArea = React.forwardRef(({ className, children, ...props }, ref) => (React.createElement(ScrollAreaPrimitive.Root, { ref: ref, className: (0, utils_1.cn)("relative overflow-hidden h-full", className), ...props },
