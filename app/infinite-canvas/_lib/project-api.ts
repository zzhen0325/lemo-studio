...
export function listProjects() {
  return requestJSON<{ projects: InfiniteCanvasProjectSummary[] }>('/api/infinite-canvas/projects');
}

export function createProject(projectName?: string) {
  return requestJSON<{ project: InfiniteCanvasProject }>('/api/infinite-canvas/projects', {
    method: 'POST',
...
export function getProject(projectId: string) {
  ...
  const request = requestJSON<{ project: InfiniteCanvasProject }>(`/api/infinite-canvas/projects/${projectId}`)
    .finally(() => {
...
export function saveProject(projectId: string, project: InfiniteCanvasProject) {
  return requestJSON<{ project: InfiniteCanvasProject }>(`/api/infinite-canvas/projects/${projectId}`, {
    method: 'PUT',
    body: project,
  });
}
...
export function duplicateProject(projectId: string) {
  return requestJSON<{ project: InfiniteCanvasProject }>(`/api/infinite-canvas/projects/${projectId}/duplicate`, {
    method: 'POST',
  });
}

export function deleteProject(projectId: string) {
  return requestJSON<{ success: true }>(`/api/infinite-canvas/projects/${projectId}`, {
    method: 'DELETE',
  });
}
