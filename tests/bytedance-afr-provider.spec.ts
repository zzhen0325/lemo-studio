...
describe("BytedanceAfrProvider", () => {
  ...
  it("uses submit_task_v2 + batch_get_result_v2 for seed4_0916_lemo", async () => {
    env.NODE_ENV = "test";
    ...
    expect(submitForm.get("req_key")).toBe("seed4_0916_lemo");
    ...
    expect(pollForm.get("req_key")).toBe("seed4_0916_lemo");
